...
Das E-Dart Gerät \enquote{LÖWEN DART HB10} stellt ein System dar, das bereits umfangreiche Funktionen für den Spielbetrieb bietet \parencite{lwenentertainment_2026_lwen}. Hierzu zählen neben dem Bereitstellung verschiedener Dart-Spiele die Erfassung von Spielerstatistiken 
die Bereitstellung von Daten über eine mobile Applikation sowie ein Verwaltungsportal für Aufsteller. Ein zentraler Aspekt des aktuellen Betriebs sind die \enquote{3K}-Turniere, bei denen alle Teilnehmer zeitgleich an demselben Gerät agieren 
...
Da die Wettbewerbe ortsungebunden durchgeführt werden können, ist eine visuelle Verifikation der sportlichen Integrität erforderlich. Um Manipulationen am Spielausgang zu verhindern, wird eine Funktion zur Videoaufnahme der Spieler sowie der Dartscheibe benötigt. 
